...
abstract class DailySuccessPlannerRecord
  ...
  @nullable
  @BuiltValueField(wireName: 'grateful_for')
  String get gratefulFor;

  @nullable
  @BuiltValueField(wireName: 'i_thank_god_for')
  String get iThankGodFor;

  @nullable
  @BuiltValueField(wireName: 'daily_affirmation')
