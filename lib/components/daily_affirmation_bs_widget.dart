...
class DailyAffirmationBsWidget extends StatefulWidget {
  const DailyAffirmationBsWidget({
    Key key,
  ...
  @override
  _DailyAffirmationBsWidgetState createState() =>
      _DailyAffirmationBsWidgetState();
}

class _DailyAffirmationBsWidgetState extends State<DailyAffirmationBsWidget> {
