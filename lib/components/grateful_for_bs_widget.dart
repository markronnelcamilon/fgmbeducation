...
class GratefulForBsWidget extends StatefulWidget {
  const GratefulForBsWidget({
    Key key,
  ...
  @override
  _GratefulForBsWidgetState createState() => _GratefulForBsWidgetState();
}

class _GratefulForBsWidgetState extends State<GratefulForBsWidget> {
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              controller: textController ??=
                                ...
                                text:
                                    columnDailySuccessPlannerRecord.gratefulFor,
                              ),
                              obscureText: false,
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    final dailySuccessPlannerUpdateData =
                                      ...
                                      gratefulFor: textController?.text ?? '',
                                    );
